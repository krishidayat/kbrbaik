...
Route::get('/posts', function () {
    ...
    return view('suara.posts', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
})->name('posts');
...
Route::get('/blog', function () {
    ...
    return view('kbrbaik-blog', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
})->name('kbrbaik.blog');
...
Route::get('/posts/{slug}', function ($slug) {
    ...
    return view($view, compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'post'));
})->name('post');
...
Route::get('/category/{slug}', function ($slug) {
    ...
    $posts = $category->posts()
        ...
        ->latest()
        ->paginate(12);
    return view('suara.category', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'category'));
})->name('category');
...
Route::get('/musik', function () {
    ...
    return view('musik', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'items'));
})->name('musik');
...
Route::get('/agenda', function () {
    ...
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-agenda', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'events', 'types'));
    }
    return view('kbrbaik-agenda', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'events', 'types'));
})->name('agenda');
...
Route::get('/komunitas', function () {
    ...
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-komunitas', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
    }
    return view('kbrbaik-komunitas', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
})->name('komunitas');
...
Route::get('/komunitas/{slug}', function ($slug) {
    ...
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-komunitas-show', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'community'));
    }
    return view('kbrbaik-komunitas-show', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'community'));
})->name('komunitas.show');
...
Route::get('/studio', function () {
    $station = request('station');
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-studio', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
    }
    return view('kbrbaik-studio', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
})->name('studio');
Route::get('/layanan', function () {
    $station = request('station');
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-services', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
    }
    return view('services', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
})->name('services');

Route::get('/pelatihan', function () {
    $station = request('station');
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-pelatihan', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
    }
    return view('pelatihan', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
})->name('pelatihan');
...
Route::get('/media', function () {
    ...
    $items = $station?->playlistItems()->where('is_active', true)->orderBy('sort_order')->get();
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-radio', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'items'));
    }
    return view('radio', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'items'));
})->name('media');
...
Route::get('/studio/{slug}', function ($slug) {
    ...
    $galleries = \App\Models\GalleryItem::where('studio_id', $studio->id)->where('is_active', true)->latest()->get();
    return view('kbrbaik-studio-show', compact('station', 'studio', 'studioPosts', 'episodes', 'galleries'));
})->name('studio.show');
Route::get('/galeri', function () {
    ...
    $invitations = AppModelsInvitation::where("invited_by", auth()->id())->latest()->take(20)->get();
    if ($station && $station->slug === 'kbrbaik') {
        return view('kbrbaik-galeri', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'items', 'episodes'));
    }
    return view('galeri', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'items', 'episodes'));
})->name('galeri');
...
Route::get('/', function () {
    ...
    if ($station && $station->slug === 'pojok') {
        return view('pojok', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
    }
    ...
    return view('home', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts', 'schedules', 'episodes', 'latestPosts'));
})->name('home');
...
Route::get('/kredensi/tulis', function () {
    ...
    return view('kredensi-dashboard', compact('station', 'categories', 'studios', 'communities', 'invitations', 'posts'));
})->name('kredensi.tulis');
